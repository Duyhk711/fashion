...
!(function (n) {
  ...
  function a(t, e, n) {
    ...
    return (
      ...
      ((h((a = t)) || "string" == typeof a) &&
        l(t.replace(X, "").replace(/<script/i, ""), e, n))
    );
  }
  function m(t, e, n, a) {
    var r = [],
    ...
    w = function (t, v) {
      ...
      (v = t),
        ...
        (this.fnPageChange = function (t, e) {
          (t = this.api(!0).page(t)), (e !== H && !e) || t.draw(!1);
        }),
  ...
  function nt(t, e) {
    ...
    t.aoColumns.push(n),
      ((n = t.aoPreSearchCols)[a] = P.extend({}, w.models.oSearch, n[a])),
      at(t, a, P(e).data());
  }
  function at(t, e, n) {
    function a(t) {
  ...
  function At(t) {
    ...
    return (
      ...
      null === (f = w.ext.legacy.ajax) ? (t.sAjaxSource ? u : p) : f ? u : p
    );
  }
  function It(t, n) {
    function e(t, e) {
  ...
  function Qt(n) {
    ...
    n.scrollBarVis !== R && n.scrollBarVis !== H
      ...
      : ((n.scrollBarVis = R),
        ...
        "" === l
          ? ((w.width = "100%"),
            x &&
              ...
              (w.width = M(D.outerWidth() - c)),
            (f = D.outerWidth()))
          : "" !== s && ((w.width = M(s)), (f = D.outerWidth())),
        k(t, e),
        k(function (t) {
        ...
        u || (x && (m.height = M(_.offsetHeight + c))),
        (R = D.outerWidth()),
        (p[0].style.width = M(R)),
        (h.width = M(R)),
  ...
  function ee(t) {
    ...
    if (g || (!h && !i && !o && s == T(t) && s == c.length))
      for (D = 0; D < s; D++) {
        var b = rt(t, D);
        null !== b && (r[b].sWidth = M(c.eq(D).width()));
      }
    else {
  ...
  function ge(t) {
    var e = w.settings;
    return -1 !== (t = P.inArray(t, N(e, "nTable"))) ? e[t] : null;
  }
  function W(t, e, n, a) {
    if (
      ((n =
        ...
        return (
          this.iterator("row", function (t, e, n) {
            ...
            gt(t.aiDisplayMaster, e),
              ...
              Se(t),
              (n = t.rowIdFn(c._aData)) !== H && delete t.aIds[n];
          }),
          this.iterator("table", function (t) {
    ...
    He =
      ...
      t("cells().nodes()", "cell().node()", function () {
        return this.iterator(
          "cell",
          function (t, e, n) {
            return (t = t.aoData[e]) && t.anCells ? t.anCells[n] : H;
          },
          1
        );
      }),
        ...
        return (
          ...
          this.iterator("table", function (e) {
            ...
            l[(o = c ? "remove" : "detach")](),
              ...
              -1 !== (u = P.inArray(e, w.settings)) && w.settings.splice(u, 1);
          })
        );
      }),
  ...
  P.extend(He, {
    ...
    P.extend(!0, w.ext.renderer, {
      pageButton: {
        _: function (f, t, d, e, h, p) {
          var g,
            b,
            n,
            m = f.oClasses,
            S = f.oLanguage.oPaginate,
            v = f.oLanguage.oAria.paginate || {};
          try {
          ...
          (function t(e, n) {
            for (
              var a,
                r,
                o,
                i = m.sPageButtonDisabled,
                l = function (t) {
                  Yt(f, t.data.action, !0);
                },
                s = 0,
                u = n.length;
              s < u;
              ...
              if (((a = n[s]), Array.isArray(a))) {
                var c = P("<" + (a.DT_el || "div") + "/>").appendTo(e);
                t(c, a);
              } else {
                switch (((g = null), (b = a), (r = f.iTabIndex), a)) {
                  case "ellipsis":
                    e.append('<span class="ellipsis">&#x2026;</span>');
                    break;
                  case "first":
                    (g = S.sFirst), 0 === h && ((r = -1), (b += " " + i));
                    break;
                  case "previous":
                    (g = S.sPrevious), 0 === h && ((r = -1), (b += " " + i));
                    break;
                  case "next":
                    (g = S.sNext),
                      (0 !== p && h !== p - 1) || ((r = -1), (b += " " + i));
                  ...
                  case "last":
                    ...
                    break;
                  default:
                    (g = f.fnFormatNumber(a + 1)),
                      (b = h === a ? m.sPageButtonActive : "");
                }
                null !== g &&
                  ((c = f.oInit.pagingTag || "a"),
                  (o = -1 !== b.indexOf(i)),
                  me(
                    P("<" + c + ">", {
