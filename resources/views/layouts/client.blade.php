                            ...
                            <ul class="default-option">
                                <li>
                                    <div class="option english">
                                        <div class="icon"><img src="{{ asset('client/images/flag/english.png') }}"
                            ...
                            <ul class="select-ul">
                                ...
                                <li>
                                    <div class="option arabic">
                                        <div class="icon"><img src="{{ asset('client/images/flag/arabic.png') }}"
                                                alt="arabic" width="24" height="24" /></div><span>Arabic</span>
                                    </div>
                                </li>
                                <li>
                                    <div class="option english">
                                        <div class="icon"><img src="{{ asset('client/images/flag/french.png') }}"
                                                alt="french" width="24" height="24" /></div><span>French</span>
                                    </div>
                                </li>
                            </ul>
                        </div>
                            ...
                            <ul class="default-option">
                                <li>
                                    <div class="option USD">
                                        <div class="icon"><img src="{{ asset('client/images/flag/usd.png') }}"
                            ...
                            <ul class="select-ul">
                                ...
                                <li>
                                    <div class="option EUR">
                                        <div class="icon"><img src="{{ asset('client/images/flag/eur.png') }}"
                                                alt="eur" width="24" height="24" /></div><span>EUR</span>
                                    </div>
                                </li>
                                <li>
                                    <div class="option GBP">
                                        <div class="icon"><img src="{{ asset('client/images/flag/gbp.png') }}"
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="logo col-5 col-sm-3 col-md-3 col-lg-2 align-self-center">
                        <a class="logoImg" href="index.html"><img src="{{ asset('client/images/logo.png') }}"
