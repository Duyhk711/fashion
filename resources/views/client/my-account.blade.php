                    ...
                    <div class="dashboard-sidebar bg-block">
                        <div class="profile-top text-center mb-4 px-3">
                            <div class="profile-image mb-3">
                                <img class="rounded-circle blur-up lazyload" data-src="{{asset('client/images/users/user-img3.jpg')}}" src="{{asset('client/images/users/user-img3.jpg')}}" alt="user" width="130" />
                            </div>
                                ...
                                <div class="bank-book-section">
                                    <div class="row g-4 row-cols-lg-3 row-cols-md-2 row-cols-sm-2 row-cols-1">
                                        <div class="address-select-box active">
                                            <div class="address-box bg-block">
                                                <div class="top bank-logo d-flex-justify-center justify-content-between mb-3">
                                                    <img src="{{asset('client/images/icons/bank-logo1.png')}}" class="bank-logo" width="40" alt="" />
                                                    <img src="{{asset('client/images/icons/visa-logo.png')}}" class="network-logo" width="50" alt="" />
                                                </div>
                                                <div class="middle">
                                        ...
                                        <div class="address-select-box">
                                            <div class="address-box bg-block">
                                                <div class="top bank-logo d-flex-justify-center justify-content-between mb-3">
                                                    <img src="{{asset('client/images/icons/bank-logo2.png')}}" class="bank-logo" width="100" alt="" />
                                                    <img src="{{asset('client/images/icons/visa-logo.png')}}" class="network-logo" width="50" alt="" />
                                                </div>
                                                <div class="middle">
                                                    <div class="card-number mb-3">
                                                    ...
                                                    <div class="form-row">
                                                        <div class="form-group col-lg-12 col-md-12 col-sm-12 col-12 mb-4">
                                                            <div class="profileImg img-thumbnail shadow bg-white rounded-circle d-flex-justify-center position-relative mx-auto">
                                                                <img src="{{asset('client/images/users/user-img3.jpg')}}" class="rounded-circle" alt="profile" width="200" height="200" />
