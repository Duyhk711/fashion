                            ...
                            <tbody>
                                ...
                                <tr class="cart-row cart-flex position-relative">
                                    ...
                                    <td class="cart-image cart-flex-item">
                                        <a href="{{route('productDetail')}}"><img class="cart-image rounded-0 blur-up lazyload"
                                    ...
                                    <td colspan="3" class="text-end">
                                        <button type="submit" name="clear"
                                            class="btn btn-outline-secondary btn-sm small-hide"><i
                                                class="icon anm anm-times-r me-2 d-none"></i> Clear Shoping
                                            Cart</button>
                    ...
                    <div class="cart-info sidebar-sticky">
                        <div class="cart-order-detail cart-col">
                            ...
                            <a href="{{route('checkout')}}" id="cartCheckout"
                                class="btn btn-lg my-4 checkout w-100">Proceed
                                To Checkout</a>
