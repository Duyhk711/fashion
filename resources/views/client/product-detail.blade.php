    ...
    <div id="page-content">
                ...
                <div class="row align-items-center">
                    <div class="col-12 col-sm-12 col-md-12 col-lg-12">
                        ...
                        <div class="breadcrumbs">
                            <a href="{{ route('pages.home') }}" title="Back to the home page">Home</a><span
                                class="main-title fw-bold"><i class="icon anm anm-angle-right-l"></i>Product
                                Layout1</span>
                        </div>
                        <!--End Breadcrumbs-->
                    </div>
        ...
        <div class="container">
                ...
                <div class="row">
                        ...
                        <div class="product-details-img product-horizontal-style">
                            ...
                            <div class="zoompro-wrap">
                                ...
                                <div class="zoompro-span">
                                    <img id="zoompro" class="zoompro"
                                        ...
                                        data-zoom-image="{{ asset('client/images/products/product1.jpg') }}" alt="product"
                                        width="625" height="808" />
                                </div>
                                <!-- End Product Image -->
                                <!-- Product Label -->
                                <div class="product-labels">
                                    <span class="lbl pr-label1">New</span><span class="lbl on-sale">Sale</span>
                                </div>
                                <!-- End Product Label -->
                                <!-- Product Buttons -->
                            ...
                            <div class="product-thumb product-horizontal-thumb mt-3">
                                <div id="gallery" class="product-thumb-horizontal">
                                    <a data-image="{{ asset('client/images/products/product1.jpg') }}"
                                        data-zoom-image="{{ asset('client/images/products/product1.jpg') }}"
                                        class="slick-slide slick-cloned active">
                                        <img class="blur-up lazyload"
                                            data-src="{{ asset('client/images/products/product1.jpg') }}"
                                            src="{{ asset('client/images/products/product1.jpg') }}" alt="product"
                                            width="625" height="808" />
                                    </a>
                                    <a data-image="{{ asset('client/images/products/product1-1.jpg') }}"
                                        data-zoom-image="{{ asset('client/images/products/product1-1.jpg') }}"
                                        class="slick-slide slick-cloned">
                                        <img class="blur-up lazyload"
                                            data-src="{{ asset('client/images/products/product1-1.jpg') }}"
                                            src="{{ asset('client/images/products/product1-1.jpg') }}" alt="product"
                                            width="625" height="808" />
                                    </a>
                                    <a data-image="{{ asset('client/images/products/product1-2.jpg') }}"
                                        data-zoom-image="{{ asset('client/images/products/product1-2.jpg') }}"
                                        class="slick-slide slick-cloned">
                                        <img class="blur-up lazyload"
                                            data-src="{{ asset('client/images/products/product1-2.jpg') }}"
                                            src="{{ asset('client/images/products/product1-2.jpg') }}" alt="product"
                                            width="625" height="808" />
                                    </a>
                                    <a data-image="{{ asset('client/images/products/product1-3.jpg') }}"
                                        data-zoom-image="{{ asset('client/images/products/product1-3.jpg') }}"
                                        class="slick-slide slick-cloned">
                                        <img class="blur-up lazyload"
                                            data-src="{{ asset('client/images/products/product1-3.jpg') }}"
                                            src="{{ asset('client/images/products/product1-3.jpg') }}" alt="product"
                                            width="625" height="808" />
                                    </a>
                                    <a data-image="{{ asset('client/images/products/product1-4.jpg') }}"
                                        data-zoom-image="{{ asset('client/images/products/product1-4.jpg') }}"
                                        class="slick-slide slick-cloned">
                                        <img class="blur-up lazyload"
                                            data-src="{{ asset('client/images/products/product1-4.jpg') }}"
                                            src="{{ asset('client/images/products/product1-4.jpg') }}" alt="product"
                                            width="625" height="808" />
                                    </a>
                                    <a data-image="{{ asset('client/images/products/product1-5.jpg') }}"
                                        data-zoom-image="{{ asset('client/images/products/product1-5.jpg') }}"
                                        class="slick-slide slick-cloned">
                                        <img class="blur-up lazyload"
                                            data-src="{{ asset('client/images/products/product1-5.jpg') }}"
                                            src="{{ asset('client/images/products/product1-5.jpg') }}" alt="product"
                                            width="625" height="808" />
                                    </a>
                                </div>
                            </div>
                            ...
                            <div class="lightboximages">
                                <a href="{{ asset('client/images/products/product1.jpg') }}" data-size="1000x1280"></a>
                                <a href="{{ asset('client/images/products/product1-1.jpg') }}" data-size="1000x1280"></a>
                                <a href="{{ asset('client/images/products/product1-2.jpg') }}" data-size="1000x1280"></a>
                                <a href="{{ asset('client/images/products/product1-3.jpg') }}" data-size="1000x1280"></a>
                                <a href="{{ asset('client/images/products/product1-4.jpg') }}" data-size="1000x1280"></a>
                                <a href="{{ asset('client/images/products/product1-5.jpg') }}" data-size="1000x1280"></a>
                            </div>
                            <!-- End Product Gallery -->
                        </div>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12 col-12 product-layout-info">
                        ...
                        <div class="product-single-meta">
                            ...
                            <div class="product-review d-flex-center mb-3">
                                <div class="reviewStar d-flex-center">
                                    <i class="icon anm anm-star"></i><i class="icon anm anm-star"></i><i
                                        ...
                                        class="icon anm anm-star-o"></i><span class="caption ms-2">24 Reviews</span>
                                </div>
                            ...
                            <div class="product-info">
                                ...
                                <p class="product-vendor">
                                    Vendor:<span class="text"><a href="#">HVL</a></span>
                                </p>
                                <p class="product-type">
                                    Product Type:<span class="text">Tops</span>
                                </p>
                                <p class="product-sku">
                                    SKU:<span class="text">RF104</span>
                                </p>
                            </div>
                            <!-- End Product Info -->
                            <!-- Product Price -->
                        ...
                        <form method="post" action="#" class="product-form product-form-border hidedropdown">
                            ...
                            <div class="product-swatches-option">
                                ...
                                <div class="product-item swatches-image w-100 mb-4 swatch-0 option1"
                                    ...
                                    <ul class="variants-clr swatches d-flex-center pt-1 clearfix">
                                        <li class="swatch x-large available active">
                                            <img src="{{ asset('client/images/products/product1-1-80x.jpg') }}"
                                                alt="image" width="80" height="80" data-bs-toggle="tooltip"
                                                data-bs-placement="top" title="Blue" />
                                        </li>
                                        <li class="swatch x-large available">
                                            <img src="{{ asset('client/images/products/product1-2-80x.jpg') }}"
                                                alt="image" width="80" height="80" data-bs-toggle="tooltip"
                                                data-bs-placement="top" title="Black" />
                                        </li>
                                        <li class="swatch x-large available purple">
                                            <img src="{{ asset('client/images/products/product1-3-80x.jpg') }}"
                                                alt="image" width="80" height="80" data-bs-toggle="tooltip"
                                                data-bs-placement="top" title="Purple" />
                                        </li>
                                        <li class="swatch x-large available green">
                                            <img src="{{ asset('client/images/products/product1-4-80x.jpg') }}"
                                                alt="image" width="80" height="80" data-bs-toggle="tooltip"
                                                data-bs-placement="top" title="Green" />
                                        </li>
                                        <li class="swatch x-large soldout yellow">
                                            <img src="{{ asset('client/images/products/product1-5-80x.jpg') }}"
                                                alt="image" width="80" height="80" data-bs-toggle="tooltip"
                                                data-bs-placement="top" title="Yellow" />
                                        </li>
                                    </ul>
                                </div>
                                <!-- End Swatches Color -->
                                ...
                                <div class="product-item swatches-size w-100 mb-4 swatch-1 option2" data-option-index="1">
                                    <label class="label d-flex align-items-center">Size:<span
                                            class="slVariant ms-1 fw-bold">S</span>
                                        <a href="#sizechart-modal" class="text-link sizelink text-muted size-chart-modal"
                                            data-bs-toggle="modal" data-bs-target="#sizechart_modal">Size
                                            Guide</a></label>
                            ...
                            <p class="infolinks d-flex-center justify-content-between">
                                <a class="text-link wishlist" href="wishlist-style1.html"><i
                                        class="icon anm anm-heart-l me-2"></i>
                                    <span>Add to Wishlist</span></a>
                                <a class="text-link compare" href="compare-style1.html"><i
                                        class="icon anm anm-sync-ar me-2"></i>
                        ...
                        <div class="userViewMsg featureText" data-user="20" data-time="11000">
                            <i class="icon anm anm-eye-r"></i><b class="uersView">21</b> People are Looking for this
                            Product
                        </div>
                        <div class="shippingMsg featureText">
                            <i class="icon anm anm-clock-r"></i>Estimated Delivery Between
                            <b id="fromDate">Wed, May 1</b> and
                            <b id="toDate">Tue, May 7</b>.
                        </div>
                        <div class="freeShipMsg featureText" data-price="199">
                            <i class="icon anm anm-truck-r"></i>Spent
            ...
            <a href="product-layout7.html" class="product-nav prev-pro clr-none d-flex-center justify-content-between"
                ...
                <span class="img"><img src="{{ asset('client/images/products/product1-120x170.jpg') }}"
                        alt="product" width="120" height="170" /></span>
            </a>
            <a href="product-layout2.html" class="product-nav next-pro clr-none d-flex-center justify-content-between"
                title="Next Product">
                <span class="img"><img src="{{ asset('client/images/products/product2-120x170.jpg') }}"
                        alt="product" width="120" height="170" /></span>
                <span class="details">
                            ...
                            <div class="row">
                                <div class="col-12 col-sm-12 col-md-8 col-lg-8">
                                    ...
                                    <ul class="checkmark-info">
                                        <li>
                                            High quality fabric, very comfortable to touch and
                                            wear.
                                        </li>
                                        <li>
                                            This cardigan sweater is cute for no reason,perfect
                                            for travel and casual.
                                        </li>
                                        <li>
                                            It can tie in front-is forgiving to you belly or tie
                                            behind.
                                        </li>
                                ...
                                <div class="col-12 col-sm-12 col-md-4 col-lg-4">
                                    <img data-src="{{ asset('client/images/content/product-detail-img.jpg') }}"
                                        src="{{ asset('client/images/content/product-detail-img.jpg') }}" alt="image"
                                    ...
                                    <div class="review-inner">
                                        <div class="spr-review d-flex w-100">
                                            <div class="spr-review-profile flex-shrink-0">
                                                <img class="blur-up lazyload"
                                                    data-src="{{ asset('client/images/users/user-img1.jpg') }}"
                                                    src="{{ asset('client/images/users/user-img1.jpg') }}" alt=""
                                        ...
                                        <div class="spr-review d-flex w-100">
                                            <div class="spr-review-profile flex-shrink-0">
                                                <img class="blur-up lazyload"
                                                    data-src="{{ asset('client/images/users/testimonial1.jpg') }}"
                                                    src="{{ asset('client/images/users/testimonial1.jpg') }}"
                    ...
                    <div class="item col-item">
                        <div class="product-box">
                            ...
                            <div class="product-image">
                                ...
                                <a href="product-layout1.html" class="product-img">
                                    <!-- Image -->
                                    <img class="primary blur-up lazyload" data-src="{{asset('client/images/products/product3.jpg')}}"
                                        src="{{asset('client/images/products/product3.jpg')}}" alt="Product" title="Product"
                                        width="625" height="808" />
                                    <!-- End Image -->
                                    <!-- Hover Image -->
                                    <img class="hover blur-up lazyload" data-src="{{asset('client/images/products/product3-1.jpg')}}"
                                ...
                                <!-- Product label -->
                                <div class="product-labels">
                                    <span class="lbl pr-label3">Trending</span>
                                </div>
                                <!-- End Product label -->
                                <!--Product Button-->
                                <div class="button-set style1">
                    ...
                    <div class="item col-item">
                        <div class="product-box">
                            ...
                            <div class="product-image">
                                ...
                                <a href="product-layout1.html" class="product-img">
                                    <!-- Image -->
                                    <img class="primary blur-up lazyload" data-src="{{asset('client/images/products/product4.jpg')}}"
                                        src="{{asset('client/images/products/product4.jpg')}}" alt="Product" title="Product"
                                        width="625" height="808" />
                                    <!-- End Image -->
                                    <!-- Hover Image -->
                                    <img class="hover blur-up lazyload" data-src="{{asset('client/images/products/product4-1.jpg')}}"
                    ...
                    <div class="item col-item">
                        <div class="product-box">
                            ...
                            <div class="product-image">
                                ...
                                <a href="product-layout1.html" class="product-img">
                                    <!-- Image -->
                                    <img class="primary blur-up lazyload" data-src="{{asset('client/images/products/product5.jpg')}}"
                                        src="{{asset('client/images/products/product5.jpg')}}" alt="Product" title="Product"
                                        width="625" height="808" />
                                    <!-- End Image -->
                                    <!-- Hover Image -->
                                    <img class="hover blur-up lazyload" data-src="{{asset('client/images/products/product5-1.jpg')}}"
                    ...
                    <div class="item col-item">
                        <div class="product-box">
                            ...
                            <div class="product-image">
                                ...
                                <a href="product-layout1.html" class="product-img">
                                    <!-- Image -->
                                    <img class="primary blur-up lazyload" data-src="{{asset('client/images/products/product6.jpg')}}"
                                        src="{{asset('client/images/products/product6.jpg')}}" alt="Product" title="Product"
                                        width="625" height="808" />
                                    <!-- End Image -->
                                    <!-- Hover Image -->
                                    <img class="hover blur-up lazyload" data-src="{{asset('client/images/products/product6-1.jpg')}}"
                                        src="{{asset('client/images/products/product6-1.jpg')}}" alt="Product" title="Product"
                                        width="625" height="808" />
                                    <!-- End Hover Image -->
                                </a>
                                <!-- End Product Image -->
                                ...
                                <div class="button-set style1">
                                    ...
                                    <a href="#addtocart-modal"
                                        ...
                                        data-bs-toggle="modal" data-bs-target="#addtocart_modal">
                                        <span class="icon-wrap d-flex-justify-center h-100 w-100" data-bs-toggle="tooltip"
                                            data-bs-placement="left" title="Out Of stock"><i
                                                class="icon anm anm-cart-l"></i><span class="text">Add to
                                                Cart</span></span>
                                    </a>
                                    <!--End Cart Button-->
                    ...
                    <div class="item col-item">
                        <div class="product-box">
                            ...
                            <div class="product-image">
                                ...
                                <a href="product-layout1.html" class="product-img">
                                    <!-- Image -->
                                    <img class="primary blur-up lazyload" data-src="{{asset('client/images/products/product7.jpg')}}"
                                        src="{{asset('client/images/products/product7.jpg')}}" alt="Product" title="Product"
                                        width="625" height="808" />
                                    <!-- End Image -->
                                    <!-- Hover Image -->
                                    <img class="hover blur-up lazyload" data-src="{{asset('client/images/products/product7-1.jpg')}}"
                                        src="{{asset('client/images/products/product7-1.jpg')}}" alt="Product" title="Product"
                                        width="625" height="808" />
                                    <!-- End Hover Image -->
                                </a>
                                <!-- End Product Image -->
                    ...
                    <div class="item col-item">
                        <div class="product-box">
                            ...
                            <div class="product-image">
                                ...
                                <a href="product-layout1.html" class="product-img">
                                    <!-- Image -->
                                    <img class="primary blur-up lazyload" data-src="{{asset('client/images/products/product8.jpg')}}"
                                        src="{{asset('client/images/products/product8.jpg')}}" alt="Product" title="Product"
                                        width="625" height="808" />
                                    <!-- End Image -->
                                    <!-- Hover Image -->
                                    <img class="hover blur-up lazyload" data-src="{{asset('client/images/products/product8-1.jpg')}}"
                                        src="{{asset('client/images/products/product8-1.jpg')}}" alt="Product" title="Product"
                                        width="625" height="808" />
                                    <!-- End Hover Image -->
                                </a>
                                <!-- End Product Image -->
                    ...
                    <div class="item col-item">
                        <div class="product-box">
                            ...
                            <div class="product-image">
                                ...
                                <a href="product-layout1.html" class="product-img">
                                    <!-- Image -->
                                    <img class="primary blur-up lazyload" data-src="{{asset('client/images/products/product9.jpg')}}"
                                        src="{{asset('client/images/products/product9.jpg')}}" alt="Product" title="Product"
                                        width="625" height="808" />
                                    <!-- End Image -->
                                    <!-- Hover Image -->
                                    <img class="hover blur-up lazyload" data-src="{{asset('client/images/products/product9-1.jpg')}}"
                                        src="{{asset('client/images/products/product9-1.jpg')}}" alt="Product" title="Product"
                                        width="625" height="808" />
                                    <!-- End Hover Image -->
                                </a>
                                <!-- End Product Image -->
                            ...
                            <div class="product-image">
                                ...
                                <a href="product-layout1.html" class="product-img">
                                    ...
                                    <img class="primary blur-up lazyload"
                                        ...
                                        src="{{asset('client/images/products/product10.jpg')}}" alt="Product" title="Product"
                                        width="625" height="808" />
                                    <!-- End Image -->
                                    <!-- Hover Image -->
                                    <img class="hover blur-up lazyload"
                                        data-src="{{asset('client/images/products/product10-1.jpg')}}"
                                        src="{{asset('client/images/products/product10-1.jpg')}}" alt="Product" title="Product"
                                        width="625" height="808" />
                                    <!-- End Hover Image -->
                                </a>
                                <!-- End Product Image -->
            ...
            <div class="modal-content">
                <div class="modal-body">
                    ...
                    <div id="ShippingInfo" class="shippingInfo-wrap">
                        ...
                        <p>
                            If you do not like the product you can return it within 15
                            days - no questions asked. This excludes bodysuits, swimwear
                            and clearance sale items. We have an easy and hassle free
                            return policy. Please look at our Delivery & Returns section
                        ...
                        <ul class="list-info">
                            ...
                            <li class="my-1">
                                <strong>Email:</strong>
                                <a href="mailto:contact@example.com"><span class="email">contact@example.com</span></a>
                            </li>
                            <li>
                                <strong>Phone:</strong>
            ...
            <div class="modal-content">
                <div class="modal-body p-0">
                    ...
                    <div class="ratio ratio-16x9 productVideo-wrap">
                        <iframe src="http://www.youtube.com/embed/93A2jOW5Mog?rel=0" title="YouTube video"
